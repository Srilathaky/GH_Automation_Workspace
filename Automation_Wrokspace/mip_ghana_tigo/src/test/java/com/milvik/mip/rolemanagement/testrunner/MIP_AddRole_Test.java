...
public class MIP_AddRole_Test {
	...
	public void addRoleOne() throws Throwable {
		try {
			...
			Assert.assertEquals(addroleepage.regCustMenu.getText().trim(),
			...
			Assert.assertEquals(addroleepage.downloadESignature.getText()
					.trim(), MIP_Menu_Constants.E_SIGNATURE.trim());
			Assert.assertTrue(addroleepage.downloadESignature_checkbox
					.isDisplayed());

			Assert.assertEquals(addroleepage.loyalty.getText().trim(),
					MIP_Menu_Constants.LOYALTY.trim());
			Assert.assertTrue(addroleepage.loyalty_checkbox.isDisplayed());

			Assert.assertEquals(addroleepage.changeDeductionMode.getText()
					.trim(), MIP_Menu_Constants.CHANGE_DEDUCTION_MODE.trim());
			Assert.assertTrue(addroleepage.changeDeductionMode_checkbox
					.isDisplayed());
			...
			Assert.assertEquals(addroleepage.deductionReportMenu.getText()
					.trim(), MIP_Menu_Constants.DEDUCTION_REPORT.trim());
			Assert.assertTrue(addroleepage.deductionReport_checkbox
					.isDisplayed());

			Assert.assertEquals(addroleepage.claimsmanageMenu.getText().trim(),
					MIP_Menu_Constants.CLAIMS.trim());
			Assert.assertTrue(addroleepage.claimsmanageMenu_checkbox
					.isDisplayed());

			Assert.assertEquals(addroleepage.claimSearch.getText().trim(),
					MIP_Menu_Constants.SEARCH_CLAIMS.trim());
			Assert.assertTrue(addroleepage.claimSearch_checkbox.isDisplayed());
	...
	public void addRoleTwo(String testcase, String roleName, String addbranch,
			String listbranch, String adduser, String listuser,
			String searchuser, String resetpassword, String applyleave,
			String viewleave, String regCust, String ipRegisterAccess,
			String searchCust, String deregCust, String downloadesignature,
			String changeDeduction, String loyalty, String coverHist,
			String editsms, String addRole, String viewRole, String custReport,
			String agentReport, String deductionReport, String claimSearch,
			String adminConfig, String msg, String fname, String sname,
			String mobilenum, String email, String dob, String gender,
			String role, String branch, String succmsg) throws Throwable {
		try {
			...
			if (regCust.equalsIgnoreCase("True")) {
				...
				if (ipRegisterAccess.equalsIgnoreCase("true"))
					addroleepage.selectIPREgisterAccess();
			}
			...
			adduserpage.enterUserInfo(fname, sname, mobilenum, email, dob,
					gender, role.trim(), branch).clickOnSave();
			...
			if (downloadesignature.equalsIgnoreCase("True"))
				Assert.assertTrue(rolemap.toString().contains(
						MIP_Menu_Constants.E_SIGNATURE));
			if (coverHist.equalsIgnoreCase("True"))
				Assert.assertTrue(rolemap.toString().contains(
						MIP_Menu_Constants.COVER_HISTORY));
			if (changeDeduction.equalsIgnoreCase("True"))
				Assert.assertTrue(rolemap.toString().contains(
						MIP_Menu_Constants.CHANGE_DEDUCTION_MODE));
			if (loyalty.equalsIgnoreCase("True"))
				Assert.assertTrue(rolemap.toString().contains(
						MIP_Menu_Constants.LOYALTY));
			...
			if (deductionReport.equalsIgnoreCase("True"))
				Assert.assertTrue(rolemap.toString().contains(
						MIP_Menu_Constants.DEDUCTION_REPORT));
			if (adminConfig.equalsIgnoreCase("True"))
				Assert.assertTrue(rolemap.toString().contains(
			...
			if (claimSearch.equalsIgnoreCase("True"))
				Assert.assertTrue(rolemap.toString().contains(
						MIP_Menu_Constants.SEARCH_CLAIMS));
	...
	@Test(testName = "TC195", dataProvider = "addroleNegativeTestData", dataProviderClass = MIP_RoleManagement_TestData.class)
	public void addRoleThree(String testcase, String roleName,
			...
			String ipRegAccess, String searchCust, String deregCust,
			String esignature, String deductionmode, String loyalty,
		...
		try {
			...
			if (regCust.equalsIgnoreCase("True")) {
				addroleepage.selectregsCust();
				if (ipRegAccess.equalsIgnoreCase("true")) {
					addroleepage.selectIPREgisterAccess();
				}
			}
			if (searchCust.equalsIgnoreCase("True"))
			...
			if (deregCust.equalsIgnoreCase("True"))
				addroleepage.selectdeRegsCust();
			if (esignature.equalsIgnoreCase("True"))
				addroleepage.selectdownloadESignature();
			if (deductionmode.equalsIgnoreCase("True"))
				addroleepage.selectchangeDeductionMode();
			if (loyalty.equalsIgnoreCase("True"))
				addroleepage.selectloyalty();
			if (coverHist.equalsIgnoreCase("True"))
			...
			if (esignature.equalsIgnoreCase("True"))
				Assert.assertFalse(addroleepage.downloadESignature_checkbox
						.isSelected());
			if (deductionmode.equalsIgnoreCase("True"))
				Assert.assertFalse(addroleepage.changeDeductionMode_checkbox
						.isSelected());
			if (loyalty.equalsIgnoreCase("True"))
				Assert.assertFalse(addroleepage.loyalty_checkbox.isSelected());
			if (coverHist.equalsIgnoreCase("True"))
			...
			if (custReport.equalsIgnoreCase("True"))
				Assert.assertFalse(addroleepage.custReport_checkbox
						.isSelected());
			if (deductionReport.equalsIgnoreCase("True"))
				Assert.assertFalse(addroleepage.deductionReport_checkbox
						.isSelected());
			if (claimsearch.equalsIgnoreCase("True"))
				Assert.assertFalse(addroleepage.claimSearch_checkbox
						.isSelected());
			if (adminConfig.equalsIgnoreCase("True"))
	...
	public void addRoleFour(String testcase, String roleName, String addbranch,
			String listbranch, String adduser, String listuser,
			String searchuser, String resetpassword, String applyleave,
			String viewleave, String regCust, String ipRegAccess,
			String searchCust, String deregCust, String esignature,
			String deductionmode, String loyalty, String coverHist,
			String editsms, String addRole, String viewRole, String custReport,
			String agentReport, String deductionReport, String claimsearch,
