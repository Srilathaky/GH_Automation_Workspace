...
public class MIP_AdminConfiguration_Test {
	...
	public void adminConfigTwo(String password, String loginid,
			...
			String offerSubscription, String comissionEarned, String announce,
		...
		try {
			...
			adminconfig.editAdminConfigInfo(password, loginid, passhist,
					loginattempt, idlestate, offerSubscription,
					comissionEarned, announce).clickOnSave();
			...
			Assert.assertTrue(admindetils
					.get("offer_subscription_last_day")
					.trim()
					.equalsIgnoreCase(
							adminconfig.getAdminConfigInfo(
									"offer_subscription_last_day").trim()));
			Assert.assertTrue(admindetils
					.get("commission_percentage")
					.trim()
					.equalsIgnoreCase(
							adminconfig.getAdminConfigInfo(
									"commission_percentage").trim()));
	...
	public void adminConfigThree(String testcase, String fields, String value,
		...
		try {
			...
			if (fields.equalsIgnoreCase("all")) {
				...
				adminconfig.clearAdminConfigInfo("offer_subscription_last_day",
						value);
				adminconfig
						.clearAdminConfigInfo("commission_percentage", value);
				adminconfig
						.clearAdminConfigInfo("registerCustomerWSURL", value);
				adminconfig.clearAdminConfigInfo("msisdnCodes", value);
