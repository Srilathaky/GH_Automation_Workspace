...
public class MIP_DeRegisterCustomer_Test {
	...
	@Test(enabled = false, testName = "DeRegisterExistingCustomer", dataProvider = "deRegisterExistingCustomer", dataProviderClass = MIP_DeRegisterCustomer_TestData.class)
