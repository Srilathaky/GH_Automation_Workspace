...
public class MIP_ApplyLeave_Test {
	...
	@Test(priority = 4, testName = "TC77", dataProvider = "applyLeaveTestData", dataProviderClass = MIP_LeaveManagement_TestData.class)
	...
	@Test(priority = 5, testName = "TC79 to TC82", dataProvider = "applyLeaveNegativeTestData", dataProviderClass = MIP_LeaveManagement_TestData.class)
	public void applyLeaveFour(String testcase, String userName,
		...
		try {
			...
			System.out.println(applyleave.getValidationMessage());
	...
	@Test(priority = 10, testName = "TC76", dataProvider = "applyLeaveTestData", dataProviderClass = MIP_LeaveManagement_TestData.class)
