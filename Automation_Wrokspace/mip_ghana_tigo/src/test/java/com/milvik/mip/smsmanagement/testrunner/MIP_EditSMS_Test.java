...
public class MIP_EditSMS_Test {
	...
	@Test(testName = "TC226-TC227", dataProvider = "EditSMSValidtyErrorMessage", dataProviderClass = MIP_SMSManagement_TestData.class, retryAnalyzer = MIP_RetryAnalyzer.class)
