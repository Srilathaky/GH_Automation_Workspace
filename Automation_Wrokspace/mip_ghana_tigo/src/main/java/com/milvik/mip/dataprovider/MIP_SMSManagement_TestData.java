...
public class MIP_SMSManagement_TestData {
	...
	public static String[][] editSMS() {
		String[][] data = { {
				...
				"Dear customer, your registrations could not be processed due to technical problems. Please try again in five minutes...",
				"3",
	...
	public static String[][] EditSMSValidtyErrorMessage() {
		String[][] data = { { "offer_subscription_successful_regular", "as",
